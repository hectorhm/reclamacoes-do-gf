...
reclamacoes = reclamacoes %>% mutate(comprimento_titulo = str_length(titulo), comprimento_reclamacao = str_length(texto))
```
...
```{r}
mod <- lm(insatisfacao ~ comprimento_reclamacao, data = reclamacoes_l)
